...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row" style="background: linear-gradient(rgba(86, 81, 81, 0.8), rgba(178, 176, 176, 0.8)), url({{$tvshow['poster_path']}});background-size:cover">
            <div class="flex-none">
                <img src="{{ $tvshow['poster_path'] }}" alt="parasite" class="w-64 lg:w-96 rounded-lg">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 md:mt-0 font-semibold">{{ $tvshow['name'] }} ({{ Str::substr($tvshow['first_air_date'] , -4 , 4)}})</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24"><g data-name="Layer 2"><path d="M17.56 21a1 1 0 01-.46-.11L12 18.22l-5.1 2.67a1 1 0 01-1.45-1.06l1-5.63-4.12-4a1 1 0 01-.25-1 1 1 0 01.81-.68l5.7-.83 2.51-5.13a1 1 0 011.8 0l2.54 5.12 5.7.83a1 1 0 01.81.68 1 1 0 01-.25 1l-4.12 4 1 5.63a1 1 0 01-.4 1 1 1 0 01-.62.18z" data-name="star"/></g></svg>
                    <span class="ml-1">{{ $tvshow['vote_average'] }}</span>
                    <span class="mx-2">|</span>
                    <i class="fas fa-users text-orange-500"></i>
                    <span class="ml-1">{{ $tvshow['vote_count'] }}</span>
                    <span class="mx-2">|</span>
                    ...
                    @if (count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            ...
                            >
                                ...
                                <span class="ml-2 text-gray-100">Play Show Trailer</span>
                            </button>
                        </div>
                ...
                @foreach ($tvshow['cast'] as $cast)
                    <div class="mt-8">
                        <a href="{{ route('actors.show', $cast['id']) }}">
                            <img src="{{ $cast['profile_path'] }}" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150 rounded-md">
                        </a>
                        <div class="mt-2">
